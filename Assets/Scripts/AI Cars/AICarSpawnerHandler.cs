...
public class AICarSpawnerHandler : MonoBehaviour
{
    //Finding the player and setting an offset ahead of the player to lock the spawn area.
    ...
    //Used to lock the Box infront of the player on the X and Y assigned.
